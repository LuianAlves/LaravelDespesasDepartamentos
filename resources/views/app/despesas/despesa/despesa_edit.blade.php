                ...
                <form method="post" action="{{ url('https://bgorcamento.herokuapp.com/despesa/atualizar') }}">
                        ...
                        <div class="col-4">
                            ...
                            <select name="departamento_id" id="departamento_id" class="form-select">
                                ...
                                @foreach ($departamentos as $departamento)
                                    <option id="departamento_{{ $departamento->id }}" value="{{ $departamento->id }}" {{$departamento->id == $despesa->departamento_id ? 'selected' : '' }}>
                        ...
                        <div class="col-4">
                            ...
                            <select name="categoria_despesa_id" id="categoria_despesa_id" class="form-select">
                                ...
                                @foreach ($categorias as $categoria)
                                    <option id="categoria_despesa_{{ $categoria->id }}" value="{{ $despesa->id }}" {{$categoria->id == $despesa->categoria_despesa_id ? 'selected' : '' }}>
                        ...
                        <div class="col-4">
                            ...
                            <select name="sub_categoria_despesa_id" id="sub_categoria_despesa_id" class="form-select">
                                ...
                                @foreach($sub_categorias as $sub)
                                    <option id="sub_cat_{{$sub->id}}" value="{{$sub->id}}" {{$sub->id == $despesa->categoria_despesa_id ? 'selected' : '' }}>{{$sub->sub_categoria_despesa}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-4">
                        <div class="col-6">
                            ...
                            <select name="metodo_pagamento_id" id="metodo_pagamento_id" class="form-select">
                                @foreach ($metodos_pagamento as $metodo)
                                    <option id="metodo_{{ $metodo->id }}" value="{{ $metodo->id }}" {{$metodo->id == $despesa->metodo_pagamento_id ? 'selected' : ''}}>
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-check form-check-inline mt-3">
                                <input class="form-check-input" type="radio" name="tipo_gasto" id="despesa" value="Despesa" {{$despesa->tipo_gasto == 'Despesa' ? 'checked' : ''}}>
                                <label class="form-check-label" for="despesa">Despesa</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="tipo_gasto" id="meta" value="Meta" {{$despesa->tipo_gasto == 'Meta' ? 'checked' : ''}}>
                                <label class="form-check-label" for="meta">Meta</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="tipo_gasto" id="despesa_meta" value="Despesa/Meta" {{$despesa->tipo_gasto == 'Despesa/Meta' ? 'checked' : ''}}>
                    ...
                    <div class="row mb-4">
                        <div class="col-6">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" name="despesa" id="despesa" class="form-control" value="{{$despesa->despesa}}" autofocus>
                            </div>
                            @error('despesa')
                                <small class="text-danger fw-bold">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" name="valor_despesa" id="valor_despesa" class="form-control" value="{{$despesa->valor_despesa}}">
                            </div>
                            @error('valor_despesa')
                                <small class="text-danger fw-bold">{{ $message }}</small>
                            @enderror
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="date" name="data_despesa" id="data_despesa" class="form-control" value="{{$despesa->data_despesa}}">
                            </div>
                            <div class="form-text">Campo Opcional</div>
                        </div>
                    </div>
