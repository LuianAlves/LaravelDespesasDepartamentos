            ...
            <div class="card-body">
                <form method="post" action="{{ url('https://bgorcamento.herokuapp.com/despesa/atualizar') }}">
                    ...
                    <div class="row mb-4">
                        <div class="col-4">
                            ...
                            <select name="departamento_id" id="departamento_id" class="form-select">
                                ...
                                <option id="departamento_{{ $departamento->id }}" value="{{ $departamento->id }}"
                        ...
                        <div class="col-4">
                            ...
                            <select name="categoria_despesa_id" id="categoria_despesa_id" class="form-select">
                                ...
                                <option id="categoria_despesa_{{ $categoria->id }}" value="{{ $despesa->id }}"
                        ...
                        <div class="col-4">
                            ...
                            <select name="sub_categoria_despesa_id" id="sub_categoria_despesa_id" class="form-select">
                                ...
                                <option id="sub_cat_{{$sub->id}}" value="{{$sub->id}}" {{$sub->id ==
                                    $despesa->categoria_despesa_id ? 'selected' : '' }}>{{$sub->sub_categoria_despesa}}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-4">
                        <div class="col-6">
                            ...
                            <select name="metodo_pagamento_id" id="metodo_pagamento_id" class="form-select">
                                ...
                                <option id="metodo_{{ $metodo->id }}" value="{{ $metodo->id }}" {{$metodo->id ==
                                    $despesa->metodo_pagamento_id ? 'selected' : ''}}>
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="tipo_gasto" id="meta" value="Meta"
                                    {{$despesa->tipo_gasto == 'Meta' ? 'checked' : ''}}>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-6">
                            <label class="form-label" for="valor_despesa_input">Valor <span class="text-danger fw-bold">
                                    *</span></label>
                            <div class="input-group input-group-merge">
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a class="btn btn-sm btn-outline-secondary"
                    href="{{url('https://bgorcamento.herokuapp.com/despesa')}}">Voltar</a>
            </div>
            <div class="card-body">
                <form method="post" action="{{ url('https://bgorcamento.herokuapp.com/despesa/atualizar') }}">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4 mb-3">
                            ...
                            <select name="sub_categoria_despesa_id" id="sub_categoria_despesa_id" class="form-select">
                                ...
                                @foreach ($sub_categorias as $sub)
                                <option id="sub_cat_{{ $sub->id }}" value="{{ $sub->id }}" {{ $sub->id ==
                                    $despesa->sub_categoria_despesa_id ? 'selected' : '' }}>
                        ...
                        <div class="col-12 col-sm-6 mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <textarea name="descricao_despesa" id="descricao_despesa" class="form-control"
                                    rows="4">{{ $despesa->descricao_despesa }}</textarea>
                            </div>
                            <div class="form-text">Campo Opcional</div>
                        </div>
                        <div class="col-12 col-sm-6 mb-3">
